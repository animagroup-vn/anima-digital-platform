        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl pt-24">
            ...
            <h1 className="font-serif text-5xl leading-tight md:text-7xl">
              THE SOUL OF<br />ASSET DEVELOPMENT
            </h1>
            ...
            <p className="mt-8 max-w-2xl text-stone">
              We awaken value where others only see space. We create legacy where others only build assets.
            </p>
            <a href="#philosophy" className="mt-10 inline-block border luxury-border px-6 py-4 text-xs uppercase tracking-[.2em] text-champagne">
